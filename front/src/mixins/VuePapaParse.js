...
// This file is under MIT Licence from it's original author (twickstrom).
// Copied due to the fact that we need PapaParse 5.x and the original author only offers 4.x version.
