<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateConfiguration() {
                this.axios.get(process.env.VUE_APP_ROOT_API + "/config")
                    .then(response => {
                        clearInterval(this.timervar);
                        this.$awn.success(this.$t("maintenance.maintenance.toaster.success"));
                        this.$store.commit('setConfiguration', response.data);
                        this.$router.push("/");
                    })
                    .catch(() => {
                        this.$awn.info(this.$t("maintenance.maintenance.toaster.error", [this.time]));
                    })
            }
        }
    }
...
<template>
    <div class="text-center">
        ...
        <h2>{{$t("maintenance.maintenance.title")}}</h2>
        <br />
        <link rel="stylesheet" type="text/css" href="/css/maintenance.css"/>

        <div class="svgAnimation">

        <svg id="rocketMan" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             viewBox="0 0 600 600">
            <defs>
            ...
            <g id="speedLines" stroke="#3e3e3e" stroke-width="2" stroke-linejoin="round">
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="74.5" y1="45" x2="74.5" y2="500" />
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="165.5" y1="142" x2="165.5" y2="574" />
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="252.5" y1="324" x2="252.5" y2="566" />
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="299.5" y1="500" x2="299.5" y2="557" />
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="347.5" y1="324" x2="347.5" y2="529" />
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="415.5" y1="8" x2="415.5" y2="440" />
                <line class="speedLine" fill="none" stroke-miterlimit="10" x1="544.5" y1="29" x2="544.5" y2="574" />
            </g>

            <g id="flow" class="shakeMe">
                <rect x="275" y="263.3" clip-path="url(#rainbowClip)" fill="#eee" width="10" height="212.7" />
                <rect x="285" y="263.3" clip-path="url(#rainbowClip)" fill="#ddd" width="10" height="212.7" />
                <rect x="295" y="263.3" clip-path="url(#rainbowClip)" fill="#ccc" width="10" height="212.7" />
                <rect x="305" y="263.3" clip-path="url(#rainbowClip)" fill="#ddd" width="10" height="212.7" />
                <rect x="315" y="263.3" clip-path="url(#rainbowClip)" fill="#eee" width="10" height="212.7" />
            </g>

            <g id="astromaute">
                <g class="pulse shakeMe" opacity="0.2" stroke="#000">
                    <path fill="none" stroke-width="3" stroke-linejoin="round" stroke-miterlimit="10" d="M289.9,188.7
                        c5.2-5.2,13.7-5.2,18.9,0" />
                    <path fill="none" stroke-width="3" stroke-linejoin="round" stroke-miterlimit="10" d="M285.6,184.5
                        c7.6-7.6,19.8-7.6,27.4,0" />
                    <path fill="none" stroke-width="3" stroke-linejoin="round" stroke-miterlimit="10" d="M281.4,180.3
                ...
                <path class="shakeMe" fill="none" stroke="#E6E6E6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" d="
                    M323.5,240.6c2.4,3.5,2.4,7.8,0,12.7 M275.8,240.6c-2.4,3.5-2.4,7.8,0,12.7" />
            </g>

            <g id="bubbles" class="jetBubbles">
                <g id="greyJets" fill="#2d2d2d">
                    <circle class="jetBubble" cx="294" cy="489" r="23" />
                    <circle class="jetBubble" cx="275" cy="470" r="20" />
                    <circle class="jetBubble" cx="320" cy="478" r="21" />
                </g>
                <g id="colorJets" stroke-width="0" stroke="#3d3d3d">
                    <circle class="jetBubble" fill="#ccc" cx="321" cy="475" r="10" />
                    <circle class="jetBubble" fill="#ddd" cx="334" cy="453" r="11" />
                    <circle class="jetBubble" fill="#eee" cx="294" cy="469" r="24" />
                    <circle class="jetBubble" fill="#ccc" cx="275" cy="450" r="20" />
                    <circle class="jetBubble" fill="#ddd" cx="324" cy="463" r="10" />
                    <circle class="jetBubble" fill="#eee" cx="295" cy="463" r="18" />
                    <circle class="jetBubble" fill="#ccc" cx="317" cy="443" r="21" />
                    <circle class="jetBubble" fill="#ddd" cx="280" cy="443.4" r="12" />
                </g>
            </g>
        </svg>
    </div>
        <br /> <br /> <br /> <br />
        <p v-html="$t('maintenance.maintenance.information', [time])"/>
        <i style="font-size: 8px;">{{$t("maintenance.maintenance.thanksTo")}}</i>
    </div>
